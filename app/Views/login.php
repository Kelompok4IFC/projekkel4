        ...
        <div class="card-body">
                ...
                <form action="login/index" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="karyawan_username" class="form-control" value="<?php echo session()->getFlashdata('karyawan_username')?>" id="inputUsername" style="border-radius: 10px; placeholder="Masukan Username....">
                    </div>
                    <div class="form-group">
                        <label for="inputPassword" class="form-label">Password</label>
                        <input type="password" name="karyawan_password" class="form-control" id="inputPassword" style="border-radius: 10px;" placeholder="Masukan Password.....">
                    </div>
                    <div class="form-group">
                        <input type="submit" name="login" class="btn btn-success btn-block" value="LOGIN" style="border-radius: 10px;">
                    </div>
                </form>
            </div>
        </div>
