...
class PeminjamanModel extends Model
{
    ...
    protected $allowedFields = ['nama_peminjam', 'nama_barang', 'tanggal', 'nama_penanggung_jawab'];
    ...
    {
        // Menyimpan entri log ke tabel log_peminjaman (nama tabel log bisa disesuaikan)
        $db = \Config\Database::connect();
        $db->table('log_peminjaman')->insert($logData);
    }
